...
import static com.net.sparrow.config.RabbitConfig.EXCEL_EXPORT_EXCHANGE;
...
public class ExcelExportTask implements IAsyncTask {
	...
	private void doExportExcel(CommonTaskEntity commonTaskEntity) {
		...
		mqHelper.send(EXCEL_EXPORT_EXCHANGE, getRoutingKey(commonNotifyEntity.getId()), commonNotifyEntity);
	}
